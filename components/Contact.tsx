...
const Contact = (props: Props) => {
  ...
  return (
    <div className="flex flex-col relative h-screen text-center md:text-left md:flex-row md:max-w-7xl px-10 justify-evenly mx-auto items-center">
